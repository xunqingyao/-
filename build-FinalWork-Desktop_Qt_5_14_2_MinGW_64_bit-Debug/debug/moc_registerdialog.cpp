...
#include <memory>
#include "../../FinalWork/registerdialog.h"
...
QT_MOC_LITERAL(1, 15, 18), // "successfulRegister"
QT_MOC_LITERAL(2, 34, 0), // ""
QT_MOC_LITERAL(3, 35, 12), // "exitRegister"
QT_MOC_LITERAL(4, 48, 24), // "on_reg_Register_released"
QT_MOC_LITERAL(5, 73, 22) // "on_reg_Cancel_released"

    },
    "registerDialog\0successfulRegister\0\0"
    "exitRegister\0on_reg_Register_released\0"
    "on_reg_Cancel_released"
};
...
void registerDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->successfulRegister(); break;
        case 1: _t->exitRegister(); break;
        case 2: _t->on_reg_Register_released(); break;
        case 3: _t->on_reg_Cancel_released(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&registerDialog::successfulRegister)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (registerDialog::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&registerDialog::exitRegister)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void registerDialog::successfulRegister()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void registerDialog::exitRegister()
{
